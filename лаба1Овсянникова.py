...
def circle_area(radius):
    ...
    return f"Ïëîùàäü êðóãà ðàâíà {area}"
...
print("Ýëåìåíòû, êîòîðûå âñòðå÷àþòñÿ òîëüêî äâà ðàçà: ", elements_with_count(array, 2))
...
c = 0  # ñ÷åò÷èê êîäîâûõ ñëîâ
a = list(itertools.product("àòîì", repeat=6))
for x in a:
    if x.count("ì") == 1:
        c += 1
print(c)
...
# Îáðàáîòêà äàííûõ JSON
# Ñîçäàåì ñïèñîê ñëîâàðåé ñ èíôîðìàöèåé î êíèãàõ
